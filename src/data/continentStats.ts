...
export const COMPETITIONS: Record<string, CompetitionData> = {
  ...
  CONMEBOL: {
    ...
    topScorers: [
      ...
      { name: 'Lionel Messi',    country: 'Argentine', countryCode: 'ar', goals: 13 },
      { name: 'Eduardo Vargas',  country: 'Chili',     countryCode: 'cl', goals: 13 },
    ],
    records: [
  ...
  CONCACAF: {
    ...
    topScorers: [
      ...
      { name: 'Javier Hernández', country: 'Mexique',    countryCode: 'mx', goals: 9  },
      { name: 'Clint Dempsey',    country: 'États-Unis', countryCode: 'us', goals: 7  },
    ],
    records: [
