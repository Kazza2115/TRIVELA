          ...
          {isAdmin && (
            <>
              ...
              <MenuItem
                ...
                label="Éditer pronostics"
                active={activeSection === 'adminbets'}
                onClick={() => { onNavigate('adminbets'); onClose() }}
              />
              ...
              <MenuItem
                icon={
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                    ...
                    <path d="M6 21v-6a3 3 0 0 1 3-3h6a3 3 0 0 0 3-3V3"/>
                  </svg>
                }
                label="Composer le bracket"
                active={activeSection === 'adminbracket'}
                onClick={() => { onNavigate('adminbracket'); onClose() }}
              />
            </>
          )}
        </div>
